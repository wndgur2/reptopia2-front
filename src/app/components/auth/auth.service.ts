...
export class AuthService {
  ...
  createUser(email:string, password:string, checkPassword:string, name: string){
  ...
  login(email: string, password: string){
    ...
    this.http.post<{token:string; expiresIn: number; userData: User}>(serverUrl+"/api/user/login", authData)
      .subscribe(response=>{
        ...
        if (response.token) {
          ...
          this.saveAuthData(response.token, expirationDate, this.userData);
